...
## Step-by-Step: Uploading a Photo
...
Photos appear on the website with the **newest uploads first**. The most recently uploaded photo will be at the top of the gallery.

---

## Uploading Multiple Photos at Once

You can select multiple photos at once when uploading:

1. Click **Upload a File**.
2. Hold **Ctrl** (Windows) or **Command** (Mac) and click each photo you want to upload.
3. Click **Open**.

All selected photos will upload together.

---

## What If a Photo Looks Wrong?

If a photo appears distorted or cropped in a way you don't like on the website, try uploading a version with a **landscape (horizontal) orientation**. Photos taken in portrait (vertical) orientation may not display as well in the gallery grid.
...
3. Right-click on it (or click the three-dot menu) and select **Delete**.
4. Confirm the deletion.

:::caution
Deleting a file from Directus **permanently removes it**. There is no trash or undo. Make sure you have a copy saved on your computer before deleting.
:::
