...
description: How to edit the final closing message at the bottom of the About page.
---
...
4. Scroll to the very bottom to find the **Closing Message** field.
...
1. Open **about** (or **about_es** for Spanish).
2. Scroll to the bottom and click the **Message** field.
3. Type your closing message.
4. Click **Save**.
...
The **Message** field supports **markdown**, so you can add bold text, paragraph breaks, and more.
