...
4. Scroll down to the **Services Section** fields.
...
## Step-by-Step: Editing the Services Section

1. Open the **home** collection (or **home_es** for Spanish).
2. Scroll down to find the **Subtitle**, **Title**, and **Description** fields.
3. Click each field and update the text as needed.
4. To update the helper note, click the **Helper Message** field and type your text.
